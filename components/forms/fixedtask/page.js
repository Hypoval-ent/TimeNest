      ...
      <div className="mt-7">
        ...
        <div className="flex p-2 mt-4">
          <div className="flex-auto flex justify-center">
            <button
              onClick={handleNext}
              className="text-base  ml-2  hover:scale-110 focus:outline-none flex justify-center w-full px-4 py-2 rounded font-bold cursor-pointer 
                 hover:bg-teal-600  
                 bg-teal-600 
                 text-teal-100 
